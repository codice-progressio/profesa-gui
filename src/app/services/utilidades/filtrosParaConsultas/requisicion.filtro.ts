...
export class RequisicionFiltros<T> extends FiltrosDeConsultas<T> {
  constructor(
    public servicio: T,
    public _folioDesde?: number,
    public _folioHasta?: number,
    public _usuario?: string,
    public _materiaPrima: 0 | 1 = 0,
    public _consumibles: 0 | 1 = 0,
    public _gastosYServicios: 0 | 1 = 0,
    public _articulo?: string,
    public _estatus_esRequisicion: 0 | 1 = 0,
    public _estatus_esOrdenDeCompra: 0 | 1 = 0,
    public _estatus_fechaDeGeneracionDeOrdenDeCompraDesde?: Date,
    public _estatus_fechaDeGeneracionDeOrdenDeCompraHasta?: Date,
    public _estatus_fechaTerminoYEntradaAlmacenDesde?: Date,
    public _estatus_fechaTerminoYEntradaAlmacenHasta?: Date,
    public _estatus_esEntregaParcial: 0 | 1 = 0,
    public _estatus_fechaEntregaParcialidadDesde?: Date,
    public _estatus_fechaEntregaParcialidadHasta?: Date,
    public _estatus_cantidadEntregadaALaFecha?: number,
    public _estatus_esTerminada: 0 | 1 = 0,
    public _estatus_fechaTerminadaDesde?: Date,
    public _estatus_fechaTerminadaHasta?: Date,
    public _estatus_esCancelada: 0 | 1 = 0,
    public _estatus_fechaCancelacionDesde?: Date,
    public _estatus_fechaCancelacionHasta?: Date
  ) {
    super()
  }
