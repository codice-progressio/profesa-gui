...
export class TransformacionComponent extends GeneralesComponents<Transformacion>
  implements OnInit {
  maquinas: Maquina[]
    ...
    let interval = setInterval(() => {
      ...
      if (this.defaults) {
        ...
        this._maquinaService
          .buscarMaquinasPorDepartamento(
            this.defaults.DEPARTAMENTOS.TRANSFORMACION
          )
          .subscribe((maquinas) => {
