export const DEPARTAMENTOS = {
    ...
    // Departamento  por de fault de todas las familias de proceso.  CONTROL_DE_PRODUCCION: { _v: 'CONTROL_DE_PRODUCCION', _n: 'CONTROL DE PRODUCCIÓN', _vm:'controlDeProduccion' },
