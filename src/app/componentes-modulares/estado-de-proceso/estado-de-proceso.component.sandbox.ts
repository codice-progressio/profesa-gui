...
import { EstadoDeProcsoMock } from 'src/app/share-sandbox/mocks/estado-de-proceso.mock'
...
export default sandboxOf(EstadoDeProcesoComponent)
  .add('1 estado', {
    template,
    context: {
      estados: EstadoDeProcsoMock.slice(0, 1)
    }
  })
  .add('5 estados', {
    template,
    context: {
      estados: EstadoDeProcsoMock.slice(0, 5)
    }
  })
  .add('10 estados', {
    template,
    context: {
      estados: EstadoDeProcsoMock
    }
  })
